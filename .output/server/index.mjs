...
import { t as toNodeListener, b as destr, m as useRuntimeConfig, l as trapUnhandledNodeErrors, s as setupGracefulShutdown, u as useNitroApp } from './chunks/_/nitro.mjs';
import 'node:events';
import 'node:buffer';
import 'node:fs';
import 'node:path';
